...
const Buttons = ({item}) =>{
    ...
    return(
        <div className="flex items-center bg-stone-200 gap-3 px-2 w-fit rounded-sm text-lg text-[#344151]">
            <button className="border-r-2 pr-3 border-[#bfbfbf]" onClick={() => handleRemoveItem(item?.card?.info?.id)}>
                    ...
                    <button className="border-l-2 pl-3 border-[#bfbfbf]" onClick={() => handleAddItem(item)}>

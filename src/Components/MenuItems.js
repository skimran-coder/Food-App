...
const MenuItems = ({restaurant}) => {
    return(
        <div className="flex justify-between pb-6 p-4 border-b-4  rounded-md border-myYellow mb-2 relative bg-myGray2">
            <div>
            ...
            <img src={IMG_CDN_URL + restaurant?.card?.info?.imageId} className="w-32 aspect-square object-cover rounded-lg"/>
                ...
                <div class="flex items-center bg-white gap-3 px-1  rounded-sm text-lg text-[#344151] absolute bottom-2 right-6">
